        ...
        <div class="content-view__feedback-card user__search-wrapper">
            <div class="feedback-card__top">
                <div class="user__search-icon">
                    ...
                    <span><?=count($user->tasks0)?> заказов</span>
                    <span><?=count($user->taskReviews)?> отзывов</span>
                </div>
                <div class="feedback-card__top--name user__search-card">
                    <p class="link-name"><a href="#" class="link-regular"><?= $user->name?></a></p>
                    <?php foreach (range(1,5) as $star):?>
                    <span <?=$star<=$user->averageRate ? '' : 'class="star-disabled"'?>></span>
                    <?php endforeach;?>
                    <b><?=number_format($user->averageRate,1)?></b>
                    <p class="user__search-content">
                        <?=$user->userInformations->about?>
                    </p>
                </div>
