                ...
                <div class="new-task__wrapper">
                    ...
                    <?php foreach ($tasks as $task): ?>
                        <div class="new-task__card">
                            ...
                            <p class="new-task__place"><?=$task->city->city.', '.$task->address. ', '.$task->latitude.','.$task->longitude?></p>
                            <span class="new-task__time"><?= floor((time() - strtotime($task->created_at))/3600).' часов назад'?></span>
                        </div>
                    <?php endforeach; ?>
                </div>
                ...
                <div class="search-task__wrapper">
                    <form class="search-task__form" name="test" method="post" action="#">
                        <fieldset class="search-task__categories">
                            ...
                            <input class="visually-hidden checkbox__input" id="2" type="checkbox" name="" value=""
                                   checked>
