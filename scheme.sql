...
CREATE TABLE IF NOT EXISTS `taskforce`.`task` (
  ...
  `added_dt` TIMESTAMP NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `taskforce`.`task_response` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `task_id` INT NOT NULL,
  `responded_user_id` INT NULL,
  `message` MEDIUMTEXT NULL,
  `dt_response` TIMESTAMP NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
